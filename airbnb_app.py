...
model_path = os.path.join(cwd, "airbnb_model.joblib")
model = joblib.load(model_path)

scl = joblib.load(os.path.join(cwd, "scaler_airbnb_right.joblib"))

city_labeling = joblib.load(os.path.join(cwd, "city.joblib"))

zip_labeling = joblib.load(os.path.join(cwd, "zip.joblib"))

pt_labeling = joblib.load(os.path.join(cwd, "pt.joblib"))

rt_labeling = joblib.load(os.path.join(cwd, "rt.joblib"))

lg_labeling = joblib.load(os.path.join(cwd, "lg.joblib"))

bt_labeling = joblib.load(os.path.join(cwd, "bt.joblib"))
